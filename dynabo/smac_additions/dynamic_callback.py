...
class ChangePriorCallback(Callback):
    ...
    def on_iteration_start(self, smbo: SMBO):
        ...
        if len(smbo.runhistory.finished) in self.intervention_schedule:
            ...
            acquisition_function.dynamic_init(acquisition_function=acquisition_function._acquisition_function, new_prior_configspace =new_prior_configspace, decay_beta=smbo._scenario.n_trials / 10)
