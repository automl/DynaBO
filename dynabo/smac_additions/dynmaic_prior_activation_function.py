...
class DynamicPriorAcquisitionFunction(PriorAcquisitionFunction):
    ...
    def __init__(
        ...
        decay_beta: float,
        prior_configsapce: ConfigurationSpace,
        ...
        self._prior_configsapce = prior_configsapce
        self._hyperparameters: dict[Any, Configuration] | None = (
            self._prior_configsapce.get_hyperparameters()
        )
    ...
    def dynamic_init(
        ...
        self._iteration_number = 1  # The amount o
    ...
    def model(self, model: AbstractModel) -> None:
        self._model = model
        # TODO Adapted by removign the hyperparameter setter
