...
if __name__ == "__main__":
    data_generation_one_seed_experimenter = PyExperimenter(DATA_GENERATION_CONFIG_PATH, CREDENTIALS_PATH)
    data_generation_medium_hard_experimenter = PyExperimenter(DATA_GENERATION_CONFIG_PATH, CREDENTIALS_PATH, table_name="data_generation_medium_hard")
    ...
    try:
        ...
        data_generation_one_seed_experimenter.get_logtable("incumbents").to_csv(DATA_GENERATION_INCUMBENT_ONE_SEED_PATH, index=False)
    except Exception:
    ...
    try:
        ...
        data_generation_medium_hard_experimenter.get_logtable("incumbents").to_csv(DATA_GENERATION_INCUMBENT_MEDIUM_HARD_PATH, index=False)
    except Exception:
